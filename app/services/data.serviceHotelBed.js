...
class DataServiceHotelBed extends Service_1.DataServiceAbstract {
    ...
    constructor() {
        ...
        this.apikey = process.env.API_HOTELBEDS_TEST;
        /**
         * Get concert about designed artist
         * @param artist Artist name
         * @returns Json about concerts
         */
        this.getHotels = (location) => __awaiter(this, void 0, void 0, function* () {
            ...
            let header = { 'X-Signature': this.signature, 'Accept': 'application/json', 'Api-key': this.apikey };
            return yield this.axiosService.get(`status`, { headers: header })
                .then(response => {
...
exports.default = new DataServiceHotelBed();
